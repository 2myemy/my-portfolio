const Hero = () => {
  return (
    <section className="min-h-[80vh] bg-warm text-main px-6 md:px-10 flex items-center">
      <div className="max-w-6xl mx-auto w-full flex flex-col md:flex-row items-center justify-between gap-8 md:gap-10 py-16 md:py-20">
        {/* Left: Text */}
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <p className="mt-8 text-lg md:text-xl font-sans text-sub leading-relaxed">
            I'm a Full-Stack Developer, focused on building intuitive,
            user-centered web applications with React and TypeScript.
            <br />I care deeply about usability, clean architecture, and
